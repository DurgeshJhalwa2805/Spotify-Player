...
const LeftSection = (props) => {
    ...
    return (
        <div className="flex md:flex-col h-full justify-between items-center md:items-start p-4 2xl:p-6">
            ...
            <div>
                <img src={SpotifyLogo} alt="Spotify Logo" className="w-20 md:w-24 2xl:w-34" />
            </div>
            <div>
